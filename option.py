...
parser.add_argument("--path_pre_pth", type=str, default='/data/LFSR/model/EPIT_5x5_4x_model.pth', help="path for pre model ckpt")
...
parser.add_argument('--path_for_train', type=str, default='/data/LFSR/data_for_training/')
parser.add_argument('--path_for_test', type=str, default='/data/LFSR/data_for_test/')
